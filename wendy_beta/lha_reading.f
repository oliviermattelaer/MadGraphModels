...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,4110000,bn,mmass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,4110000,bn,mwidth,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,param1 ,0d0)
       call set_it(n,ivalue,value,name,2,bn,param2 ,0d0)
      return
      end
